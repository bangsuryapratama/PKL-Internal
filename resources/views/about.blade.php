                    ...
                    <div class="row common__row position-relative">
                        <div class="col-xl-2 col-lg-2 col-md-6">
                            <div class="headerarea__logo">
                                <a href="#"><img src="{{asset('assets/img/logo/logo__1.png')}}" alt=""></a>
                            </div>
                        </div>
                                            ...
                                            <ul class="headerarea__submenu headerarea__megamenu">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="categories.html">
                                                                <img class="img-fluid" src="{{asset('assets/img/collection/collection__1.png')}}"
                                                                    alt="Collection">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <li class="mega__menu__li mega__menu__image">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="categories.html">
                                                                <img class="img-fluid" src="{{asset('assets/img/collection/collection__2.png')}}"
                                                                    alt="Collection">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <li class="mega__menu__li mega__menu__image">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="categories.html">
                                                                <img class="img-fluid" src="{{asset('assets/img/collection/collection__3.png')}}"
                                                                    alt="Collection">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <li class="mega__menu__li mega__menu__image">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="categories.html">
                                                                <img class="img-fluid" src="{{asset('assets/img/collection/collection__4.png')}}"
                                                                    alt="Collection">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <li class="mega__menu__li mega__menu__image">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="categories.html">
                                                                <img class="img-fluid" src="{{asset('assets/img/collection/collection__5.png')}}"
                                                                    alt="Collection">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <li class="mega__menu__li mega__menu__image">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="categories.html">
                                                                <img class="img-fluid" src="{{asset('assets/img/collection/collection__6.png')}}"
                                                                    alt="Collection">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <li class="mega__menu__li mega__menu__image">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="categories.html">
                                                                <img class="img-fluid" src="{{asset('assets/img/collection/collection__7.png')}}"
                                                                    alt="Collection">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <li class="mega__menu__li mega__menu__image">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="categories.html">
                                                                <img class="img-fluid" src="{{asset('assets/img/collection/collection__8.png')}}"
                                                                    alt="Collection">
                                                            </a>
                                                        </li>
                                                    </ul>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-4 col-5">
                        <div class="mobile-logo">
                            <a class="logo__mobile" href="#"><img src="{{asset('assets/img/logo/logo__1.png')}}" alt="logo"></a>
                        </div>
                    </div>
                    <div class="col-sm-4 col-5">
            ...
            <div class="mobile-off-canvas-active">
                ...
                <div class="header-mobile-aside-wrap">
                    ...
                    <div class="mobile__logo">
                        <a href="index.html">
                            <img src="{{asset('assets/img/logo/logo__1.png')}}" alt="Logo">
                        </a>
                    </div>
                    ...
                    <div class="minicart__wrapper">
                        ...
                        <div class="minicart__single__wraper">
                            <div class="minicart__single">
                                ...
                                <div class="minicart__single__img">
                                    <a href="single-product.html">
                                        <img src="{{asset('assets/img/grid/grid__1.png')}}" alt="product">
                                    </a>
                            ...
                            <div class="minicart__single">
                                ...
                                <div class="minicart__single__img">
                                    <a href="single-product.html">
                                        <img src="{{asset('assets/img/grid/grid__2.png')}}" alt="product">
                                    </a>
                                    <div class="minicart__single__close">
                                        <button title="Remove"><i class="fa fa-close"></i></button>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-12">
                            <div class="about__img">
                                <img src="{{asset('assets/img/about/about__1.jpg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="video__img">
                                <img src="{{asset('assets/img/about/video-banner__1.jpg')}}" alt="">
                    ...
                    <div class="brand__wraper brand__slider__active">
                        <div class="brand__single">
                            <div class="brand__img">
                                <img src="{{asset('assets/img/brand/brand-logo-1.png')}}" alt="">
                            </div>
                        </div>

                        <div class="brand__single">
                            <div class="brand__img">
                                <img src="{{asset('assets/img/brand/brand-logo-2.png')}}" alt="">
                            </div>
                        </div>

                        <div class="brand__single">
                            <div class="brand__img">
                                <img src="{{asset('assets/img/brand/brand-logo-3.png')}}" alt="">
                            </div>
                        </div>

                        <div class="brand__single">
                            <div class="brand__img">
                                <img src="{{asset('assets/img/brand/brand-logo-4.png')}}" alt="">
                            </div>
                        </div>

                        <div class="brand__single">
                            <div class="brand__img">
                                <img src="{{asset('assets/img/brand/brand-logo-5.png')}}" alt="">
                            </div>
                        </div>

                        <div class="brand__single">
                            <div class="brand__img">
                                <img src="{{asset('assets/img/brand/brand-logo-6.png')}}" alt="">
                            </div>
                        </div>

                        <div class="brand__single">
                            <div class="brand__img">
                                <img src="{{asset('assets/img/brand/brand-logo-7.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
...
<h5>Guaranteed safe checkout</h5>
                            <div class="footer__img">
                                <ul>
                                    <li>
                                        <img src="{{asset('assets/img/footer/footer__1.svg')}}" alt="">
                                    </li>
                                    <li>
                                        <img src="{{asset('assets/img/footer/footer__2.svg')}}" alt="">
                                    </li>
                                    <li>
                                        <img src="{{asset('assets/img/footer/footer__3.svg')}}" alt="">
                                    </li>
                                    <li>
                                        <img src="{{asset('assets/img/footer/footer__4.svg')}}" alt="">
                                    </li>
                                    <li>
                                        <img src="{{asset('assets/img/footer/footer__5.svg')}}" alt="">
                                    </li>
                                    <li>
                                        <img src="{{asset('assets/img/footer/footer__6.svg')}}" alt="">
                                    </li>
                                </ul>
                            </div>
                </div>
